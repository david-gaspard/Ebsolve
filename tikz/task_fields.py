#!/usr/bin/env python3
#-*- coding: utf-8 -*-
## Created on 2024-01-26 at 10:30:59 CET by David Gaspard <david.gaspard@espci.fr>
## Python script to automatically generate a TikZ file from a template in order to plot the results of the "task_fields" operation of the Ebsolve program.
## USAGE : ./templates/task_fields.py "FILENAME_FIELDS" "TITLE"
## FILENAME_FIELDS  = Data file generated by Ebsolve containing the Qn(x) and Jn(x) fields (Input file, CSV format).
## TITLE            = LaTeX title of the TikZ figure (Input string).
import sys
import os
import compile_tikz

TEMPLATE_TIKZ = "tikz/task_fields.tikz"   ## TikZ template for the "task_fields" operation of the Ebsolve program.
...
def main(args):
    ...
    ## 2. Deduce the file path of the output TikZ file from the data file "*.fields.csv":
    ...
    dic = {## Substitution dictionary:
        ##"filename_fields": os.path.basename(args[1]),
        ##"filename_solver": os.path.basename(args[2]),
        "title": args[2]
    }
