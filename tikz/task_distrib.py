#!/usr/bin/env python3
#-*- coding: utf-8 -*-
## Created on 2024-01-29 at 11:33:43 CET by David Gaspard <gaspard.dave@gmail.com>
## Python script to automatically generate a TikZ file from a template in order to plot the results of the "task_distrib" operation of the Ebsolve program.
## USAGE : ./tikz/task_distrib.py "FILENAME_DISTRIB" "TITLE"
## FILENAME_DISTRIB  = Data file generated by Ebsolve containing the rho(T) distribution (Input file, CSV format).
## TITLE             = LaTeX title of the TikZ figure (Input string).
import sys
import os
import compile_tikz

TEMPLATE_TIKZ = "tikz/task_distrib.tikz"   ## TikZ template for the "task_distrib" operation of the Ebsolve program.
